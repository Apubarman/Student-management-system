...
<html>
<head>
	<title>Edit Admin Access Registration</title>
	...
	<div class="container" style="background: #fff2f8; padding: 20px; width: 600px; border-radius: 50px; margin-top: 70px;">
		<div class="row justify-content-center">
        	<div class="col-md-6 col-md-offset-3" align="center">
        		...
        		<form method="post" action="updateadminaccess.php">
        			<?php
					    $id = $_GET['id'];
        		  ...
        		  <input type="text" id="inputUsername" class="form-control" placeholder="Enter Your Username...." name="username" style="margin-bottom: 10px; font-family: 'Pacifico', cursive;" value="<?php echo $data['username'];?>" required="">
			      
			      <input type="text" id="inputPassword" class="form-control" placeholder="Enter Your Password..." name="password" style="margin-bottom: 25px; font-family: 'Pacifico', cursive;" value="<?php echo $data['password'];?>" required="">
